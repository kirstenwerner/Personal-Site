...
class Portfolio extends Component {
  ...
  render() {
    ...
    let skillzApp = {
      ...
      notes:
        "Skillz Gym is designed to allow the user to create and track daily workouts. 'Skillz' are stored in a database with a wealth of information, and then may be selected for a daily workout with a user-designed prescription. This app is built with Rails and PostgreSQL on the back-end, and Rails, JavaScript, JQuery, and CSS on the front-end. OAuth and Devise are used to allow third party login via FaceBook. Skillz Gym includes forms built in both JavaScript and Ruby on Rails.",
      blogPosts: [
        {
          title:
            "Updating my Rails app with JavaScript and using Prototype methods",
          link:
            "https://medium.com/kirsten-werner/updating-my-rails-app-with-javascript-and-using-prototype-methods-ed49c80c4aa9"
        },
        {
          title:
            "What I learned while writing an MVC web application with Ruby on Rails",
          link:
            "https://medium.com/kirsten-werner/what-i-learned-while-writing-an-mvc-web-application-with-ruby-on-rails-3a0585e94884"
        }
      ]
    };
    ...
    let rememberall = {
      ...
      blogPosts: [
        {
          title:
            "Writing my first Sinatra web app - Seattle Restaurant Rememberall",
          link:
            "https://medium.com/kirsten-werner/writing-my-first-sinatra-web-app-seattlerestaurantrememberall-a7fb4e03ce91"
        }
      ]
    };
    ...
    let skiReport = {
      ...
      notes:
        "WashingtonSkiReport is a Ruby CLI Gem that allows the user to view a list of all of the ski resorts in Washington State, and to select to view more information about each resort, such as a bio, details about the resort, and weather/snow conditions where available.",
      blogPosts: [
        {
          title: "Creating my first Ruby CLI gem",
          link:
            "https://medium.com/kirsten-werner/creating-my-first-ruby-cli-gem-48e3f5f89222"
        }
      ]
    };
